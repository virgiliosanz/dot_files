...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-link aggressive-indent all-the-icons auctex-latexmk auto-compile
              ...
              centered-cursor-mode clean-aindent-mode cmake-mode code-review
              column-enforce-mode company-auctex company-c-headers company-lua
              company-math company-reftex company-web cpp-auto-include dap-mode
              ...
              flycheck-package flycheck-pos-tip gendoxy ggtags gh-md git-link
              git-messenger git-modes git-timemachine gitignore-templates
              gnuplot golden-ratio google-c-style google-translate helm-ag
              ...
              json-mode json-navigator json-reformat link-hint livid-mode
              lorem-ipsum lsp-latex lsp-origami lsp-ui macrostep markdown-toc
              ...
              popwin prettier-js pug-mode quickrun rainbow-delimiters
              restart-emacs ron-mode rust-mode rustic sass-mode scss-mode
              slim-mode smeargle space-doc spaceline spacemacs-purpose-popwin
              spacemacs-whitespace-cleanup string-edit-at-point
              string-inflection symbol-overlay symon tagedit term-cursor toc-org
              ...
              writeroom-mode ws-butler xterm-color yasnippet-snippets)))
(custom-set-faces
